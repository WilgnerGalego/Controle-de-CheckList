      ...
      <Paper sx={{ p: 3, mb: 3 }}>
        <Grid container spacing={2}>
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            <TextField label="Data inicial" type="date" value={filters.start} onChange={(event) => setFilters((current) => ({ ...current, start: event.target.value }))} fullWidth sx={{ '& .MuiInputBase-root': { minWidth: { xs: '100%', sm: 180 } }, '& .MuiInputBase-input': { boxSizing: 'border-box', pr: 4 } }} />
          </Grid>
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            <TextField label="Data final" type="date" value={filters.end} onChange={(event) => setFilters((current) => ({ ...current, end: event.target.value }))} fullWidth sx={{ '& .MuiInputBase-root': { minWidth: { xs: '100%', sm: 180 } }, '& .MuiInputBase-input': { boxSizing: 'border-box', pr: 4 } }} />
          </Grid>
